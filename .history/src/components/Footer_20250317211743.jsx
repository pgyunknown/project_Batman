...
{/* <footer className="bg-black text-white py-6">
  <div className="container mx-auto flex flex-col md:flex-row md:justify-evenly justify-between items-center self-center">
    <p className="mb-4 text-sm">made with ❤️</p>
    ...
    <p className="mt-4 text-xs">&copy; 2025 Chill Dev.</p>
  </div>
</footer> */}
  ...
  <div className="container mx-auto flex flex-col md:flex-row items-center justify-between text-center md:text-left px-4">
    <p className="text-sm mb-4 md:mb-0">Follow me on</p>
    <div className="flex space-x-6">
      <!-- GitHub -->
      <a href="https://github.com" target="_blank" className="hover:text-gray-400">
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    <p className="mt-4 md:mt-0 text-xs">© 2025 Chill Dev</p>
  </div>
</footer>
