...
{/* <footer class="bg-black text-white py-6">
  <div class="container mx-auto flex flex-col md:flex-row md:justify-evenly justify-between items-center self-center">
    <p class="mb-4 text-sm">made with ❤️</p>
    <div class="flex space-x-6">

      
      <a href="https://github.com" target="_blank" class="hover:text-gray-400">
    ...
    <p class="mt-4 text-xs">&copy; 2025 Chill Dev.</p>
  </div>
</footer> */}
    
    <footer class="bg-gray-900 text-white py-6">
  <div class="container mx-auto flex flex-col md:flex-row items-center justify-between text-center md:text-left px-4">
    <p class="text-sm mb-4 md:mb-0">Follow me on</p>
    <div class="flex space-x-6">
      <!-- GitHub -->
      <a href="https://github.com" target="_blank" class="hover:text-gray-400">
        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    <p class="mt-4 md:mt-0 text-xs">© 2025 Chill Dev</p>
  </div>
</footer>
