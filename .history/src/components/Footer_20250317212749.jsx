...
const Footer = () => {
  ...
  <div className="container mx-auto flex flex-col md:flex-row items-center justify-between px-4">
    <p className="mb-5 md:m-0 text-xs md:text-sm">made with ❤️</p>
    <div className="flex space-x-6">
      ...
      <a href="https://linkedin.com" target="_blank" className="hover:text-blue-700">
        <svg className=" w-3 h-3md:w-6 md:h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    <p className="mt-5 md:m-0 text-xs md:text-sm">&copy; 2025 Chill Dev.</p>
  </div>
</footer>
