...
const Footer = () => {
  ...
  <div className="container mx-auto flex flex-col md:flex-row items-center justify-between px-4 font-bold">
    <p className="mb-5 md:m-0 text-sm">made with ❤️</p>
    ...
    <p className="mt-5 md:m-0 text-xs">&copy; 2025 Chill Dev.</p>
  </div>
</footer>
