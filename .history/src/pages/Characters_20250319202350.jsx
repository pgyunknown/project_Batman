...
<div className='grid md:grid-cols-2 lg:grid-cols-4 shrink-0 grid-cols-1 gap-4 text-white bg-blue-400'>
  {coreCharacters.map((i, n) => (
    <div 
      key={n} 
      className='flex flex-col justify-around m-5  bg-black font-inter md:tracking-wider tracking-tight font-lighter border-[0.5px] border-gray-500 rounded-xl h-lvh'
    >
