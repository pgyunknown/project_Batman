...
const Home = () => {
  return (
    ...
    <div className="w-full sm:h-screen  text-2xl">
      ...
      <div className='md:my-5 md:mx-5 p-2 md:p-0'>
        <h1 className='text-2xl sm:p-2 md:text-3xl font-anton tracking-wide'>Which technologies were used to build this project?</h1>
        <p className='sm:text-2xl sm:p-2 text-sm tracking-wide font-web border-b-2 border-gray-400'>
          The project is built using React(Vite), Tailwind CSS, and JavaScript, combining a responsive design for an engaging experience.
            ...
            <div className='md:my-5 md:mx-5 p-2 md:p-0'>
        <h1 className='text-2xl sm:p-2 md:text-3xl font-anton tracking-wide'>What content can I find here?</h1>
        <p className='sm:text-2xl sm:p-2 text-sm tracking-wide font-web border-b-2 border-gray-400'>
          You'll find character bios, iconic quotes, storyline summaries, and character appearances in Batman universe.
            ...
            <div className='md:my-5 md:mx-5 p-2 md:p-0'>
        <h1 className='text-2xl sm:p-2 md:text-3xl font-anton tracking-wide'>Is this project still a work in progress?</h1>
        <p className='sm:text-2xl sm:p-2 text-sm tracking-wide font-web border-b-2 border-gray-400'>
