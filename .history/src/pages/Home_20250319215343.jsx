  ...
  return (
    ...
    <div className="w-full sm:h-screen  text-2xl  ">
      ...
      <div className='sm:my-5 sm:mx-5'>
        <h1 className='sm:text-4xl sm:p-2 text-5xl font-anton tracking-wide '>What is this?</h1>
      ...
      <div className='sm:my-5 sm:mx-5'>
        <h1 className='sm:text-4xl sm:p-2 text-5xl font-anton tracking-wide'>Which technologies were used to build this project?</h1>
        <p className='sm:text-2xl sm:p-2 text-sm tracking-wide font-web border-b-2 border-gray-400'>
        ...
        <p className='sm:text-2xl sm:p-2 text-sm tracking-wide font-web border-b-2 border-gray-400'>
          TYou'll find character bios, iconic quotes, movies, and character appearances in Batman universe and his allies and foes.
